Rails.application.configure do
  ...
  config.action_mailer.asset_host = ("https://mapping-humanity-production.herokuapp.com")
  config.action_controller.asset_host = "https://mapping-humanity-production.herokuapp.com"
